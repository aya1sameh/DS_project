...
void GUI::PrintMessage(string msg,int c) const	//Prints a message on status bar
{
	...
	if (c==0)
	{ClearStatusBar();
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-20), msg);
	}// You may need to change these coordinates later 
	if (c==1)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-40), msg);  // to be able to write multi-line
	if (c==2)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-60), msg);
	if (c==3)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-80), msg);
	if (c==4)
		pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-100), msg);
	if (c==5)
        pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-115), msg);
}
//////////////////////////////////////////////////////////////////////////////////////////
